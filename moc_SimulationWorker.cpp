...
QT_MOC_LITERAL(4, 49, 6) // "result"

    },
    "SimulationWorker\0simulationComplete\0"
    "\0std::string\0result"
};
...
void SimulationWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->simulationComplete((*reinterpret_cast< const std::string(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SimulationWorker::*)(const std::string & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SimulationWorker::simulationComplete)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SimulationWorker::simulationComplete(const std::string & _t1)
{
