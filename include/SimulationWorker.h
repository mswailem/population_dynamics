...
public:
    SimulationWorker(int lattice_size, int num_of_timesteps, double n0, double death_rate, double birth_rate, double pred_rate);
...
private:
    int lattice_size, num_of_timesteps;
